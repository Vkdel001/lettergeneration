...
os.makedirs("output_letters_company", exist_ok=True)
...
for index, row in df.iterrows():
    ...
    name = f"{owner1_surname}"  # Use only Owner 1 Surname for company name
    ...
    pdf_filename = f"output_letters_company/{safe_policy}_{safe_name}.pdf"  # Define the PDF filename
    ...
    address_lines = [name]  # Start with the company name
