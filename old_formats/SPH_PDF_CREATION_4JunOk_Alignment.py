...
for index, row in df.iterrows():
    ...
    text6 = "4. If you are experiencing financial difficulties or require payment facilities to settle the arrears or for any queries, please contact our office on 602 3315 immediately or email us on nicarlife@nicl.mu to discuss for any payment arrangements."
    ...
    text8 = "You can now pay using the QR code displayed below with any of your preferred payment app like Juice or MyT Money."
